...
using LogMe_Server.Models.AccountViewModels;
using LogMe_Server.Services;
...
namespace LogMe_Server.Controllers
{
    [Authorize]
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (user.CellPhone != null)
                        claims.Add(new Claim("CellPhone", user.CellPhone));
                    if (user.Street != null)
                        claims.Add(new Claim("Street", user.Street));
                    if (user.Number != null)
                        claims.Add(new Claim("Number", user.Number.ToString()));
                    if (user.Complement != null)
                        claims.Add(new Claim("Complement", user.Complement));
                    if (user.Neighbourhood != null)
                        claims.Add(new Claim("Neighbourhood", user.Neighbourhood));
                    if (user.City != null)
                    ...
                    if (user.CEP != null)
                        claims.Add(new Claim("CEP", user.CEP.ToString()));
